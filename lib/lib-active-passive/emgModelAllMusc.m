function [currentMuscleTable,currentNeurEval,columnNames] = emgModelAllMusc(trial_data_cell,td_trim,params)
    ...
    [emgIndeces] = find(ismember(td_trim(1).emg_names,emgMuscles));
