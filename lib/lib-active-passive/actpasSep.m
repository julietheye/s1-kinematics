    ...
    %% set up model variables
        ...
        for modelnum = 1:num_models-1
            ...
            case 'allMuscKin'
                glm_params{modelnum} = struct('model_type',model_type,...
                                        'model_name',[model_aliases{modelnum} '_model'],...
                                        'in_signals',{{'muscle_len',muscleIndeces(1:20);'muscle_vel',muscleIndeces(1:20)}},...
                                        'out_signals',neural_signals);
                                    
            case 'allMuscEMG'
                glm_params{modelnum} = struct('model_type',model_type,...
                                        'model_name',[model_aliases{modelnum} '_model'],...
                                        'in_signals',{{'muscle_len',muscleIndeces(1:20);'muscle_vel',muscleIndeces(1:20);'emg',emgIndeces(1:20)}},...
                                        'out_signals',neural_signals);
            ...
            case 'extAccel'
                ...
                glm_params{modelnum} = struct(...
                    'model_type',model_type,...
                    'model_name',[model_aliases{modelnum} '_model'],...
                    'in_signals',{{'markers',marker_hand_idx;'marker_vel',marker_hand_idx;'marker_accel',marker_hand_idx}},...
                    'out_signals',neural_signals);
            case 'handle_ext'
                glm_params{modelnum} = struct(...
                    'model_type',model_type,...
            ...
            case 'handelbowAccel'
                ...
                glm_params{modelnum} = struct('model_type',model_type,...
                                        'model_name',[model_aliases{modelnum} '_model'],...
                                        'in_signals',{{'markers',[marker_hand_idx marker_elbow_idx];'marker_vel',[marker_hand_idx marker_elbow_idx];'marker_accel',[marker_hand_idx marker_elbow_idx]}},...
                                        'out_signals',neural_signals);
            case 'markers_pca'
                ...
                glm_params{modelnum} = struct('model_type',model_type,...
                                        ...
                                        'out_signals',neural_signals);
            case 'markers_pcaAccel'
                % Get PCA for marker space
                td_bin = dimReduce(td_bin,struct('signals','markers'));
                td_bin = dimReduce(td_bin,struct('signals','marker_vel'));
                td_bin = dimReduce(td_bin,struct('signals','marker_accel'));
                glm_params{modelnum} = struct('model_type',model_type,...
                                        'model_name',[model_aliases{modelnum} '_model'],...
                                        'in_signals',{{'markers_pca',1:num_musc_pcs;'marker_vel_pca',1:num_musc_pcs;'marker_accel_pca',1:num_musc_pcs}},...
                                        'out_signals',neural_signals);
